...
(function () {
  ...
  function loadGame() {
    ...
    var intv = setInterval(function () {
      try {
        ...
        for (var n = 0; n < totalRso; n++) {
          ...
          if (m % 2 == 0) rso[n][8] = n % 2 == 0 ? "#000" : "#fff";else rso[n][8] = n % 2 == 1 ? "#000" : "#fff";
        }
    ...
    c.addEventListener("touchend", getTouchEnd); //Key..
    /// TODO: Change this zone to implement posenet

    function getKey(e) {
      e.preventDefault();
      var ty = e.keyCode; // identifies the keycode and changes the direction with it
    ...
    function getKeyEnd(e) {
      var ty = e.keyCode;
      if (ty === 39) cl = false;else if (ty === 37) cr = false;
    }

    document.body.removeEventListener("keydown", getKey);
    document.body.removeEventListener("keyup", getKeyEnd); // action performed when a key is starting or finishing pressed

    document.body.addEventListener("keydown", getKey);
    document.body.addEventListener("keyup", getKeyEnd); /// TODO: Change this zone to implement posenet
    // Steps:
...
//# sourceMappingURL=/CarDrivingPoseNetController.e31bb0bc.js.map